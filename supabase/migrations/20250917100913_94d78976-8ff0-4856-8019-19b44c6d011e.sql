...
CREATE POLICY IF NOT EXISTS "Users can view messages for joined or owned projects"
...
CREATE POLICY IF NOT EXISTS "Users can send messages in joined or owned projects"
ON public.project_messages
FOR INSERT
WITH CHECK (
  sender_id = auth.uid()
